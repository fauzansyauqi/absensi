                ...
                <?php else : ?>
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="absen_pulang_sampai" name="absen_pulang_sampai" value="<?= $nameapp = (empty($dataapp['absen_pulang'])) ? '15:00:00' : $dataapp['absen_pulang']; ?>">
                            </div>
                        </div>
                        <div class="form-group row">
