                ...
                <div class="card-body">
                    ...
                    <div class="container">
                        <div class="d-flex align-items-center justify-content-center small">
                            <div class="text-muted">made &copy; <?= date("Y"); ?><a href="<?= base_url(); ?>" class="ml-1"><?= $appname = (empty($dataapp['nama_app_absensi'])) ? 'Absensi Online' : $dataapp['nama_app_absensi']; ?></a>
                                <div class="d-inline">Powered By<a href="https://www.youtube.com/@kaseps8304/videos" class="ml-1">Fauzan syauqi</a></div>
                            </div>
                        </div>
                    </div>
                </div>
